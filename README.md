...
starts CLI agents in detached managed tmux sessions; for OpenCode it starts a
local headless API server and creates the session through that API. The first
