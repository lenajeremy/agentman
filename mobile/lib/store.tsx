	...
	useEffect(() => {
	  void (async () => {
		  try {
			...
			// SecureStore can reject after an OS restore or keychain reset. Do
			// not leave the provider permanently on its blank loading screen;
			// let the user pair again and recover.
			setCredentials(null);
